...
<br>User name in the application context object is:<%=application.getAttribute("applicationUserName") %>
<br>User name in the page context object is:<%=application.getAttribute("pageContextUserName") %>
